...
public class Config {
    ...
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.artisan.qianghongbao.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.artisan.qianghongbao.ACCESSBILITY_CONNECT";

    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.artisan.qianghongbao.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.artisan.qianghongbao.NOTIFY_LISTENER_CONNECT";
